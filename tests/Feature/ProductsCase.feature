...
#   * User delete the account
  ...
  Scenario:04 User Verify View Category Products and View & Cart Brand Products
   Given user click on Products Button and verify user should navigate to ALL PRODUCTS page successfully
   When User click on the All Category to verify user should be able to view products under that category
   Then User click on the All Brands to verify user should be able to view products under that brand
